# Use Qri's Starlib for Starlark in Go to send HTTP(s) requests from inside WASM

## Instructions for this devcontainer

Tested with Go 1.22.1, Bun 1.0.35, Deno 1.41.3, starlib [v0.5.0](https://github.com/qri-io/starlib/releases/tag/v0.5.0).
...
```sh
cd browser-and-deno-starlib
```

2. Install starlib. This also installs starlark-go as dependency:
